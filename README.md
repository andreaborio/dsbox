...
- **Resident when it safely fits.** Qualified Qwen3.6 and GLM-5.2 runtimes use DS4's guarded Metal AUTO planner, keeping the complete model resident when the working set and current pressure allow it and falling back to SSD otherwise.
