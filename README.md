...
- **The right memory path automatically.** Qwen3.6 stays resident when its guarded Metal preflight allows it; the 244 GiB GLM-5.2 ExpertMajor artifact selects its qualified SSD/cache plan automatically.
