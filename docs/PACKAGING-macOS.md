...
names, canonical DMG filename, icon, bundle identifier, package and bundle
versions, exact architecture, ASAR header integrity, packaged `package.json`,
absence of embedded engine executables, checksum when required by the release
